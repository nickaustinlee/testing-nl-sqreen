...
module.exports = function (identity, module) {
    ...
    module.application.lazyrouter = function () {
        ...
        this._router.use(Util.sqreenErrMiddleWare);
    ...
    module.application.use = function () {
        ...
        if (fn.length === 4) {
            use.apply(this, [Util.sqreenErrMiddleWare]);
        }

        if (cookieAndBodyNames.indexOf(fn.name) > -1) {
            const result = use.apply(this, arguments);
            use.apply(this, [getMiddleWare(), Util.sqreenErrMiddleWare]);
            return result;
        }
        return use.apply(this, arguments);
    };
