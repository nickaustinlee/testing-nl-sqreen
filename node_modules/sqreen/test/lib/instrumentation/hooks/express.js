...
describe('Hook Express', () => {
    ...
    describe('express 2', () => {
        ...
        it('should place the middleware on express2', { plan: 1 }, (done) => {
            ...
            const EHook = Proxyquire(Hook, {
                '../patcher': {
                    savedModules: {
                        'express:lib/http.js': arr
                    }
                }
            });

            EHook({ version: '2.15.0' }, {});

            const app = new arr[0].module();
            ...
            expect(app.call).to.have.length(4);
    ...
    it('should place the bind if possible and place the secret middleware', { plan: 5 }, (done) => {
        ...
        arr[3].module.prototype.handle_request({}, {}, () => {
            ...
            expect(app._sq_lazy_done).to.be.true();
            expect(app.middle[0]).to.be.a.function();
            expect(app.middle[2]).to.equal('/');
            done();
        });
    });
