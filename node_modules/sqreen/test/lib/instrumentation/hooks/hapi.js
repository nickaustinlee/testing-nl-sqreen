...
describe('Hook hapi', () => {
    ...
    it('should hook a hapi server when a connection is created and cover other cases', { plan: 5 }, (done) => {
            ...
            '../functionPatcher': {
                patchFunction: function (holder, key) {
                    ...
                    holder[key] =  function (request) {
                        ...
                        require('../../../../vendor/continuation-local-storage/context').getNamespace('sqreen_session').set('req', null);
                        expect(request.method).to.equal('get');
                    };
                }
            }
        ...
        const ns = require('../../../../vendor/continuation-local-storage/context').getNamespace('sqreen_session');
        ns.run(() => {
