...
describe('WhiteList', () => {
    ...
    describe('IP', () => {
        ...
        it('should test the IP white', { plan: 9 }, (done) => {
            ...
            expect(WhiteList.ipIsWhiteListed('E06')).to.equal('');
    ...
    describe('Path', () => {
        ...
        it('should test the Path whitelist', { plan: 8 }, (done) => {

            expect(WhiteList.pathIsWhiteListed('/home')).to.equal('');
            expect(WhiteList.pathIsWhiteListed()).to.equal('');
            expect(WhiteList.pathIsWhiteListed(/foo/)).to.equal('');
