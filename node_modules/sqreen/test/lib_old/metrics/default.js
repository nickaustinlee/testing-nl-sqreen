...
const Default = require('../../../lib_old/metric/default');
...
describe('Metric Old', () => {
    ...
    describe('Default', () => {
        ...
        it.skip('shsould create and delete defauls monit metric', { plan: 2 }, (done) => {
            ...
            require('../../../lib/command/features').featureHolder.performance_metrics_period = 10;

            Default.enableWhitelisted();
            Default.enableRequestOvertime();
            Default.enablePerfMonitorPct(1,2,3);
            Default.enablePerfMonitor(1,2,3);
            Default.disablePerfMonitor();
            Default.enablePerfForRule('aaa');
